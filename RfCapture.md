...
***confirm***: running 2 rtlsdr (config as rtl=0, rtl=1) has minimal impact on cpu utilisation. Performing various fft calculations for both rtlsdr (in multi Dongle 44) then cpu usage 70%.
