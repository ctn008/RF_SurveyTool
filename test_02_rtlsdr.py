...
class test_02_rtlsdr(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_02_rtlsdr")
        ...
        self.top_layout.addWidget(self._frequency_mhz_tool_bar)
        ...
        self.rtlsdr_source_0_0.set_center_freq((int(frequency_mhz*1e6)), 0)
        ...
        self.rtlsdr_source_0_0.set_gain(1, 0)
        ...
        self.rtlsdr_source_0.set_center_freq((int(frequency_mhz*1e6)), 0)
        ...
        self.connect((self.rtlsdr_source_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_frequency_mhz(self, frequency_mhz):
        ...
        self.rtlsdr_source_0.set_center_freq((int(self.frequency_mhz*1e6)), 0)
        self.rtlsdr_source_0_0.set_center_freq((int(self.frequency_mhz*1e6)), 0)




def main(top_block_cls=test_02_rtlsdr, options=None):
