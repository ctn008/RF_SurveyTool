...
class generate_rfbb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "generate_rfbb")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            (1024*16), #size
            channel_rate*interpolation, #samp_rate
            "", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, (channel_rate*interpolation), True, 0 if "auto" == "auto" else max( int(float(0.1) * (channel_rate*interpolation)) if "auto" == "time" else int(0.1), 1) )
        ...
        self.connect((self.analog_random_source_x_0_0_0, 0), (self.epy_block_1_0_0, 0))
        ...
        self.connect((self.epy_block_1_0, 0), (self.rational_resampler_xxx_0_0, 0))
        self.connect((self.epy_block_1_0_0, 0), (self.rational_resampler_xxx_0_0_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.blocks_multiply_xx_0_0_0, 1))
    ...
    def set_interpolation(self, interpolation):
        ...
        self.analog_sig_source_x_0.set_sampling_freq((self.channel_rate*self.interpolation))
...
def main(top_block_cls=generate_rfbb, options=None):
