...
class test2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-1, 1000)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/home/ctn008/myrtlsdr/build/abc/1734852476_histogram.int16', False, 0, 0)
