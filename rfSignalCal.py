...
class rfSignalCal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rfSignalCal")
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff((1/127.5))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((1/127.5))
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/ctn008/coverageTool/samples_01/f397.5mhz_g49.6_s1638400_t1733018717.85.uint8', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_deinterleave_0, 0))
...
def main(top_block_cls=rfSignalCal, options=None):
