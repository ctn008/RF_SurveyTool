/* 
Compile from source:
g++ -std=c++17 -o RfCaptureCpp.exe RfCaptureCpp.cpp RtlSdrCpp.cpp -ID:\myrtlsdr\include -ID:\MinGW64\include D:\myrtlsdr\librtlsdr.o 
D:\mingw64\lib\libusb-1.0.dll.a .\tuner_e4k.o .\tuner_fc0012.o .\tuner_fc0013.o .\tuner_r82xx.o .\tuner_fc2580.o

Complie from source & dll
g++ -std=c++17 -o RfCaptureCpp.exe RfCaptureCpp.cpp RtlSdrCpp.cpp -ID:\myrtlsdr\include -ID:\MinGW64\include D:\myrtlsdr\librtlsdr.dll 
*/
#include <iostream>
#include <fstream>
#include <vector>
...
int main(int argc, char* argv[]) {
    ...
    uint32_t freq = 100000000;  // Default frequency (100 MHz)
    ...
    try {
        ...
        rtlSdr2.setSampleRate(2560000);  // Default sample rate
