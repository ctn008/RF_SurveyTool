...
class multi_dongle_48(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Multi Dongle 48", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Multi Dongle 48")
        ...
        self.settings = Qt.QSettings("GNU Radio", "multi_dongle_48")
        ...
        self.rtlsdr_source_1.set_center_freq((cent_freq - samp_rate/2), 0)
        ...
        self.rtlsdr_source_0.set_center_freq((cent_freq +samp_rate/2), 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.rtlsdr_source_0.set_center_freq((self.cent_freq +self.samp_rate/2), 0)
        self.rtlsdr_source_1.set_sample_rate(self.samp_rate)
        self.rtlsdr_source_1.set_center_freq((self.cent_freq - self.samp_rate/2), 0)
...
def main(top_block_cls=multi_dongle_48, options=None):
